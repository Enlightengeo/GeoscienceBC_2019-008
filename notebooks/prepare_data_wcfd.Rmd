...
write.csv(well_geology_df, paste0('../wcfd_data/',run_date,'_well_geology_df_wcfd.csv'))
```
...
```{R}
well_geology_df <- read.csv(paste0('../wcfd_data/',run_date,'_well_geology_df_wcfd.csv'))
...
saf_wells_sf %>% 
  ...
  sf::st_drop_geometry() %>%
  data.table::fwrite(., paste0('../wcfd_data/',run_date,'_saf_well_data_wcfd.csv'))

write_rds(saf_wells_sf, paste0('../wcfd_data/',run_date,'_saf_well_data_wcfd.rds'))
```