...
model_prefix = 'classif_model_cart_bcogc/cart_bcogc'
input_data = "../output/bcogc_mldf.rds"
model_type = "classif.rpart"

pset= makeParamSet(
  makeNumericParam('cp',lower = -3, upper = -0.1, trafo = function(x) 10^x),
...
feat_imp = plot_feat_imp(generateFeatureImportanceData(task=all_task, learner=tuned_learner), label=model_prefix)
