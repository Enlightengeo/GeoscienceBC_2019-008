...
input_data = "../output/final_bcogc_mldf.rds"
...
classif_importance = generateFilterValuesData(all_task, method = "FSelector_information.gain")

p1 = ggplot(classif_importance$data) +
  geom_col(aes(x = name, y = FSelector_information.gain)) +
