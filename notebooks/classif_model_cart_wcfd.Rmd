...
model_prefix = 'classif_model_cart_wcfd/cart_wcfd'
input_data = "../wcfd_data/final_wcfd_mldf.rds"
...
feat_imp = plot_feat_imp(getFeatureImportance(model), label=model_prefix)
