...
write.csv(well_geology_df, paste0('../output/',run_date,'_well_geology_df.csv'))
```
...
```{R}
well_geology_df <- read.csv(paste0('../output/',run_date,'_well_geology_df.csv'))
...
saf_wells_sf %>% 
  ...
  sf::st_drop_geometry() %>%
  data.table::fwrite(., paste0('../output/',run_date,'_saf_well_data.csv'))
