...
```{R}
saf_wells_sf <- read_rds('../output/2020_06_27_bcogc_saf_well_data.rds')
...
numeric_input_cols <- c(
  ...
  "breakdown_isip_ratio", "min_midpoint_dist",  "horiz_wells_in_1km", 
...
```{r}
write_csv(ml_df, paste0("../output/",run_date,"_mldf.csv"))
write_rds(ml_df, paste0("../output/",run_date,"_mldf.rds"))
```